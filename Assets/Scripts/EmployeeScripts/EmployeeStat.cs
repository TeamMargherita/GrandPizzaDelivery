...
public class EmployeeStat : MonoBehaviour
{
    ...
    public string[] RanName { get; } = new string[31] { "엠마", "리암", "올리비아", "노아", "에바", "이사벨라", "소피아", "미아", "잭슨", "에이든", "루카스", "아멜리아", "벤자민",
    "하퍼", "에단", "샤를로트", "아비게일", "제임스", "릴리", "헨리", "알렉산더", "윌리엄", "사무엘", "다니엘", "칼리브", "그레이스", "미셸", "스칼렛", "엘리자", "엘라", 
        "이사벨라"};
