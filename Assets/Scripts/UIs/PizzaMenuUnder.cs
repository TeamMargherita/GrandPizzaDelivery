...
// 한석호 작성
public class PizzaMenuUnder : MonoBehaviour, IPointerEnterHandler, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
	...
	public void Update()
	{
		...
		if (isEnter)
		{
			if (menuListRect.localPosition.y <= 540)
			{
			...
			else
			{
				...
				{
					menuListRect.localPosition = new Vector3(0, 540);
				}
			}
		}
